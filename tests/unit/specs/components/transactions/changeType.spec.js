...
describe('Change Type', function () {
    ...
    let accounts;
    beforeEach(function () {
        transaction = { id: 1, payee: 'John', notes: 'Notes', date: '2017-01-01', amount: 30, type: 'income', accountId: 'account-1', balance: 100 };
        accounts = [{ id: 'account-1' }, { id: 'account-2' }, { id: 'account-3' }];
    });
    ...
    describe('Invert amount', function() {
        [
            ...
            it(`should ${negateAmount ? 'negate' : 'not negate'} amount when changing from ${originalType} to ${newType}`, function() {
