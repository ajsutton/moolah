        ...
        <v-row>
          ...
          <v-col :cols="12" :md="4" class="d-flex text-center">
            <v-scroll-y-transition mode="out-in">
              ...
              <v-card v-else :key="category.id" class="pt-6 mx-auto" flat max-width="400">
                <v-card-text>
                  <v-avatar size="88">
                    <v-icon xLarge>folder_open</v-icon>
                  </v-avatar>
                  <h3 class="headline mb-2">{{categoryName}}</h3>
                  <category-name :category="category" :editable="true" ref="categoryName"></category-name>
                </v-card-text>
